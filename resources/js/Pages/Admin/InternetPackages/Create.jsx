...
export default function Create({ auth, festivals, provinces }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        is_featured: false,
        festival_id: "",
        festival_special_price: false,
        festival_price: "",
        has_night_free: false,
        is_night_free: false,
        night_free_start_time: "22:00",
        night_free_end_time: "06:00",
        night_free_speed_mb: "",
        provinces: [],
    });
    ...
    // Get festival status text and class
    const getFestivalStatusClass = (festival) => {
        if (!festival.is_active) {
            return { text: t('internet_packages.inactive'), class: "bg-gray-100 text-gray-800" };
        }
        ...
        if (today < startDate) {
            ...
            return { text: t('internet_packages.expired'), class: "bg-red-100 text-red-800" };
        } else {
            return { text: t('internet_packages.active'), class: "bg-green-100 text-green-800" };
        }
    };
    ...
    const onSubmit = (e) => {
        ...
        post(route("admin.internet-packages.store"));
    };
            ...
            <div className="p-4 space-y-6">
                <div className="flex justify-between items-center">
                    <h2 className="text-xl font-semibold">
                        {t('internet_packages.create_package')}
                    </h2>
                    <Link
                ...
                <div className="p-4 sm:p-8 py-8 bg-white shadow border sm:rounded-lg">
                    <form onSubmit={onSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="volume_fixed">
                                            {t('internet_packages.volume_fixed')}
                                        </option>
                                        <option value="volume_daily">
                                            {t('internet_packages.volume_daily')}
                                        </option>
                                    </SelectInput>
                                    <InputError
                                        message={errors.type}
                        ...
                        {data.type !== "unlimited" && (
                            <div>
                                <h3 className="text-lg font-medium text-gray-900 mb-4 pb-2 border-b">
                                    {t('internet_packages.volume_speed_info')}
                                </h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {(data.type === "volume_fixed" ||
                                        ...
                                        <div>
                                            <InputLabel
                                                ...
                                                value={t('internet_packages.total_volume_gb')}
                                            />
                                            <TextInput
                                                id="total_volume_gb"
                                                type="number"
                                    ...
                                    {data.type === "volume_daily" && (
                                        <div>
                                            <InputLabel
                                                ...
                                                value={t('internet_packages.daily_limit_gb')}
                                            />
                                            <TextInput
                                                id="daily_limit_gb"
                                                type="number"
                                    ...
                                    <div>
                                        <InputLabel
                                            htmlFor="speed_mb"
                                            value={t('internet_packages.speed_mb')}
                                        />
                                        <TextInput
                                            id="speed_mb"
                                            type="number"
                                    ...
                                    {data.type === "volume_daily" && (
                                        <div>
                                            <InputLabel
                                                ...
                                                value={t('internet_packages.after_daily_limit_speed_mb') || "سرعت پس از اتمام حجم روزانه (Mb/s)"}
                                            />
                                            <TextInput
                                            ...
                                            />
                                            <InputError
                                                message={errors.after_daily_limit_speed_mb}
                                                className="mt-2"
                                            />
                                        </div>
                                    )}
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center">
                                        <h3 className="text-md font-medium">
                                            {t('internet_packages.speed_ranges')}
                                        </h3>
                                        <button
                                            type="button"
                                    ...
                                    {speedSlots.map((slot, index) => (
                                        ...
                                        >
                                            <div>
                                                <InputLabel
                                                    htmlFor={`from_${index}`}
                                                    value={t('internet_packages.from_hour')}
                                                />
                                                <TextInput
                                                    id={`from_${index}`}
                                                    type="time"
                                            ...
                                            <div>
                                                <InputLabel
                                                    htmlFor={`to_${index}`}
                                                    value={t('internet_packages.to_hour')}
                                                />
                                                <TextInput
                                                    id={`to_${index}`}
                                                    type="time"
                                            ...
                                            <div>
                                                <InputLabel
                                                    ...
                                                    value={t('internet_packages.speed')}
                                                />
                                                <TextInput
                                                    id={`speed_${index}`}
                                                    type="number"
                                            ...
                                            <div className="flex items-end">
                                                {speedSlots.length > 1 && (
                                                    ...
                                                    >
                                                        {t('internet_packages.delete_range')}
                                                    </button>
                                                )}
                                            </div>
                                        </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <InputLabel
                                        ...
                                        value={t('internet_packages.enable_night_mode')}
                                    />
                                </div>
                                        ...
                                        <div className="mb-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <InputLabel
                                                    ...
                                                    value={t('internet_packages.free_night_usage')}
                                                />
                                            </div>
                                            <p className="text-sm text-gray-500 mt-1 mx-2">
                                                {data.is_night_free
                                                    ? t('internet_packages.night_free_msg')
                                                    : t('internet_packages.night_speed_msg')}
                                            </p>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div>
                                                <InputLabel
                                                    ...
                                                    value={t('internet_packages.start_time')}
                                                />
                                                <TextInput
                                            ...
                                            <div>
                                                <InputLabel
                                                    ...
                                                    value={t('internet_packages.end_time')}
                                                />
                                                <TextInput
                                            ...
                                            <div>
                                                <InputLabel
                                                    ...
                                                    value={
                                                        data.is_night_free
                                                            ? t('internet_packages.night_free_speed')
                                                            : t('internet_packages.night_speed')
                                                    }
                                                />
                                                <TextInput
                            ...
                            {festivals && festivals.length > 0 ? (
                                <div className="space-y-4">
                                    <p className="text-sm text-gray-700 mb-4">
                                        {t('internet_packages.assign_to_festival')}
                                    </p>
                                ...
                                <div className="text-center py-6 text-gray-500">
                                    {t('internet_packages.no_festivals')}
                                </div>
                            )}
                        </div>
                        ...
                        <div className="flex items-center justify-end">
                            <PrimaryButton
                                ...
                                className="mr-4"
                            >
                                {t('internet_packages.save_package')}
                            </PrimaryButton>
                        </div>
                    </form>
                </div>
    ...
    const handleFileChange = async (e) => {
        ...
        try {
            const imageUrl = await uploadImage(
                file,
                "admin.site-items.upload", // یا روت مربوط به آپلود تصویر جشنواره
                "image"
            );
            onUpload(imageUrl);
        } catch (error) {
